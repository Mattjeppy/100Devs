...
// If the product is greater than 100 add the sum 
// of the last two numbers and console log the value. 
// If the product is less that 100, subtract the difference of 
// the last two numbers and console log the value. If the product is 100,
